...
namespace TygaSoft.WebHelper
{
    public static class MC
    {
        ...
        public const string Submit_Data_NotExists = "数据不存在或已被删除，请检查！";
        ...
        public const string Submit_Ex_Error = "异常，原因：{0}";
        ...
        public const string Request_NotExist = "{0}不存在或已被删除，请检查！";
        public const string Request_InvalidCompareToPassword = "前后输入密码不一致！";
        public const string Request_SysError = "对不起，系统发生异常，原因：{0}";
        public const string Request_InvalidPassword = "密码应由数字、字母、特殊字符（不包括“&”）组成，且是6-30位的字符串！";
