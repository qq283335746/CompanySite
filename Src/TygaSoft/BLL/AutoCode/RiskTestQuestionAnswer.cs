...
{
    public partial class RiskTestQuestionAnswer
    {
        private static readonly IRiskTestQuestionAnswer dal = DataAccess.CreateRiskTestQuestionAnswer();

        #region RiskTestQuestionAnswer Member
