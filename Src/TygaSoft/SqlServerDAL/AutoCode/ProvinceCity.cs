...
namespace TygaSoft.SqlServerDAL
{
    public partial class ProvinceCity : IProvinceCity
    {
        ...
        {
            StringBuilder sb = new StringBuilder(250);
            sb.Append("delete from ProvinceCity where Id = @Id");
        ...
        public List<ProvinceCityInfo> GetList(int pageIndex, int pageSize, out int totalRecords, string sqlWhere, params SqlParameter[] cmdParms)
        {
            ...
            totalRecords = (int)SqlHelper.ExecuteScalar(SqlHelper.GzxySiteDbConnString, CommandType.Text, cmdText, cmdParms);
        ...
        public List<ProvinceCityInfo> GetList()
        {
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.GzxySiteDbConnString, CommandType.Text, cmdText))
            {
                if (reader != null && reader.HasRows)
                {
                    while (reader.Read())
