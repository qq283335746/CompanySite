...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'center',title:''">
        <div id="toolbar" style="padding:5px;">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="ListUser.EditUserBase()">基本信息</a>
        </div>
...
<script type="text/javascript" src="../../Scripts/Admin/ListUser.js"></script>
