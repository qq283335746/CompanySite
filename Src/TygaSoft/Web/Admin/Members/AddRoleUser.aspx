...
<div class="m10">
    <strong>角色：</strong>
    <span runat="server" id="lbRole" clientidmode="Static"></span>
</div>
...
<table id="bindT" class="easyui-datagrid" title="用户" data-options="singleSelect:true,rownumbers:true,pagination:true,fitColumns:true,toolbar:'#toolbar'">
    <thead>
        <tr>
