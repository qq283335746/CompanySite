...
<table id="bindT" class="easyui-datagrid" title="角色列表" data-options="fit:true,rownumbers:true,singleSelect:true,toolbar:'#toolbar'">
<thead>
    <tr>
        <th data-options="field:'f0',checkbox:true"></th>
        <th data-options="field:'f1'">角色名称</th>
        <th data-options="field:'f2'">添加/移除用户</th>
    </tr>
</thead>
<tbody>
...
<script type="text/javascript">
    var currFun = {
        Add: function () {
            $("#hId").val("");
            $("#txtRolename").val("");
            currFun.Url = "/sw/ScriptServices/AdminService.asmx/SaveRole";
        ...
        Del: function () {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: "/sw/ScriptServices/AdminService.asmx/DelRole",
                        type: "post",
