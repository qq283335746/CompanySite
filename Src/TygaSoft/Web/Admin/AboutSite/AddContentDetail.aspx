...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="/sw/Scripts/plugins/kindeditor/themes/default/default.css" rel="stylesheet" type="text/css" />
    <link href="/sw/Scripts/plugins/kindeditor/plugins/code/prettify.css" rel="stylesheet" type="text/css" /> 
    <script type="text/javascript" src="/sw/Scripts/JeasyuiExtend.js"></script>
    <script type="text/javascript" src="/sw/Scripts/plugins/kindeditor/kindeditor.js"></script>
    <script type="text/javascript" src="/sw/Scripts/plugins/kindeditor/lang/zh_CN.js"></script>
    <script type="text/javascript" src="/sw/Scripts/plugins/kindeditor/plugins/code/prettify.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="easyui-panel" style="padding:10px;">
        ...
        <div class="row mt10">
            ...
            <div class="fl">
                <img id="imgPicture" runat="server" clientidmode="Static" src="/sw/Images/nopic.gif" alt="上传图片" width="688" height="200" onclick="DlgPictureSelect.DlgSingle('PictureContent')" /><br />
    ...
    <div id="dlgSingleSelectPicture" class="easyui-dialog" title="选择图片（单选）" data-options="closed:true,modal:true,href:'/sw/t/tpicture.html?dlgId=dlgSingleSelectPicture&funName=PictureContent',width:810,height:$(window).height()*0.8,
    buttons: [{
    ...
    <script type="text/javascript" src="/sw/Scripts/Admin/DlgPictureSelect.js"></script>
    <script type="text/javascript" src="/sw/Scripts/Admin/AboutSite/AddContentDetail.js"></script>
    <script type="text/javascript">
        var editor_content;
        KindEditor.ready(function (K) {
            editor_content = K.create('#txtContent', {
                uploadJson: '/sw/h/ty.html',
                fileManagerJson: '/sw/h/ty.html',
