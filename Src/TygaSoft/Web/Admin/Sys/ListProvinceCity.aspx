<%@ Page Title="省市区管理" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListProvinceCity.aspx.cs" Inherits="TygaSoft.Web.Admin.Sys.ListProvinceCity" %>
...
href:'/Templates/AddProvinceCity.htm',buttons: [{
...
<script type="text/javascript" src="../../Scripts/Admin/ProvinceCity.js"></script>
<script type="text/javascript">
    $(function () {
        try {
            $("#dlg").dialog('refresh', '/Templates/AddProvinceCity.htm');
            ProvinceCity.Init();
        }
        catch (e) {
