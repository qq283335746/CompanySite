...
var ListPictureContent = {
    ...
    Add: function () {
        DlgPictureSelect.TableName = "PictureContent";
        DlgPictureSelect.CallBack = "ListPictureContent.OnUploadCallBack()";
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "/sw/ScriptServices/AdminService.asmx/DelPictureContent",
                        type: "post",
