var ListRiskTestQuestionAnswer = {
    Init: function () {
        this.Grid(sPageIndex, sPageSize);
    },
    InitSearchItem: function () {
        var keyword = $.trim(ListRiskTestQuestionAnswer.GetMyData($("#myDataForSearch")).keyword);
        if (keyword != "") {
    ...
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "/sw/ScriptServices/AdminService.asmx/DelRiskTestQuestionAnswer",
                        type: "post",
                        ...
                        success: function (data) {
                            ...
                            ListRiskTestQuestionAnswer.ReloadGrid();
                        }
                    });
                }
            });
