...
namespace TygaSoft.SqlServerDAL
{
    public partial class SysEnum
    {
        ...
        public bool IsExist(string name, object parentId, object Id)
        {
            Guid gId = Guid.Empty;
            if (Id != null)
            {
            ...
            {
                sb.Append(@" select 1 from [Sys_Enum] where lower(EnumCode) = @Named and ParentId = @ParentId and Id <> @Id ");
            ...
            {
                sb.Append(@" select 1 from [Sys_Enum] where lower(EnumCode) = @Named and ParentId = @ParentId ");
            }
