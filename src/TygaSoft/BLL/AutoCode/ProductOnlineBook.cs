...
{
    public partial class ProductOnlineBook
    {
        private static readonly IProductOnlineBook dal = DataAccess.CreateProductOnlineBook();

        #region ProductOnlineBook Member
