...
var DlgPictureSelect = {
    ...
    DlgSingle: function (tableName) {
        ...
        if (this.DlgOpenId == "") this.DlgOpenId = "dlgSingleSelectPicture";
        this.IsMutil = false;
        $('#' + this.DlgOpenId + '').dialog('open');
    },
    DlgMutil: function (tableName) {
        this.TableName = tableName;
        if (this.DlgOpenId == "") this.DlgOpenId = "dlgMutilSelectPicture";
        this.IsMutil = true;
        $('#' + this.DlgOpenId + '').dialog('open');
    },
    SetSinglePicture: function (imgEleId) {
        ...
        if (data.length > 0) {
            ...
            if (DlgPictureSelect.DlgOpenId == "") DlgPictureSelect.DlgOpenId = "dlgSingleSelectPicture";
            $("#" + DlgPictureSelect.DlgOpenId + "").dialog('close');
        }
    },
    ...
    DlgUpload: function () {
        ...
        $("#dlgUploadPicture").dialog({
            ...
            closed: false,
            modal: true,
            href: '/sw/t/ypicture.html?dlgId=dlgUploadPicture&funName=' + tableName + '&isMutil=' + isMutil + '&dlgParentId=' + dlgParentId + '&callBack=' + callBack + '&submitUrl=/sw/h/tupload.html',
            buttons: [{
