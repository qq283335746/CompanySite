...
var ProvinceCity = {
    ...
    Load: function () {
        ...
        $.ajax({
            url: "/sw/ScriptServices/AdminService.asmx/GetJsonForProvinceCity",
            type: "post",
            data: "{}",
    ...
    Add: function () {
        this.Url = "/sw/ScriptServices/AdminService.asmx/SaveProvinceCity";
        var t = $("#treeCt");
        ...
        if (node) {
            $.messager.confirm('温馨提醒', '确定要删除吗?', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/sw/ScriptServices/AdminService.asmx/DelProvinceCity",
                        contentType: "application/json; charset=utf-8",
                        data: "{id:'" + node.id + "'}",
                        beforeSend: function () {
                            $("#dlgWaiting").dialog('open');
