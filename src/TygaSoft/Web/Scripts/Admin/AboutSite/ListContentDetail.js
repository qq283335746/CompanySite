...
var ListContentDetail = {
    ...
    Search: function () {
        window.location = "?keyword=" + $.trim($("[id$=txtKeyword]").val()) + "";
    },
    Add: function () {
        window.location = "gaboutsite.html";
    },
    Edit: function () {
        ...
        window.location = "gaboutsite.html?Id=" + cbl[0].f0;
    },
    Del: function () {
        try {
            ...
            $.messager.confirm('温馨提醒', '确定要删除吗？', function (r) {
                if (r) {
                    $.ajax({
                        url: "/sw/ScriptServices/AdminService.asmx/DelContentDetail",
                        type: "post",
