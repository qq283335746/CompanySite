...
namespace TygaSoft.Web
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        private void Bind()
        {
            ...
            try
            {
                if (Request.Cookies["Sw_UserInfo"] != null && !string.IsNullOrEmpty(Request.Cookies["Sw_UserInfo"].Value))
                {
                    var sLoginInfo = Request.Cookies["Sw_UserInfo"].Value;
        ...
        private void OnLogin()
        {
            ...
            try
            {
                ...
                var cookie = Request.Cookies["Sw_LoginVc"];
                ...
                if (isRemember)
                {
                    ...
                    Response.Cookies.Add(new HttpCookie("Sw_UserInfo", sUserInfo));
                }
                else
                {
                    Response.Cookies.Add(new HttpCookie("Sw_UserInfo", ""));
                }
