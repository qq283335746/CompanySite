...
<div class="easyui-panel" title="类别字典" data-options="fit:true">
    <div class="mtb5">
       ...
       <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="ListContentType.CreateShareMenu()">生成前台功能菜单</a>
    </div>
   <ul id="treeCt" class="easyui-tree" style="padding-left: 5px; margin-top:10px;"></ul>
   <div id="mmTree" class="easyui-menu" style="width:200px;">
       ...
       <div onclick="ListContentType.CreateShareMenu()" data-options="iconCls:'icon-remove'">生成前台功能菜单</div>
   </div> 
</div>

<div id="dlg" class="easyui-dialog" title="新建/编辑类型字典" data-options="iconCls:'icon-save',closed:true,modal:true,
href:'/sw/Templates/AddContentType.htm',buttons: [{
...
<script type="text/javascript" src="/sw/Scripts/Admin/ListContentType.js"></script>
<script type="text/javascript">
    $(function () {
        try {
            $("#dlg").dialog('refresh', '/sw/Templates/AddContentType.htm');
